...
class CsvImport_IndexController extends Omeka_Controller_AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $this->session->autodetectItemTypeCollection = $form->getValue('bsf_autodetect_type_collection');
    ...
    public function mapColumnsAction()
    {
        ...
        $form = new CsvImport_Form_Mapping(array(
            ...
            'autodetectItemTypeCollection' => $this->session->autodetectItemTypeCollection
        ));
        $this->view->form = $form;
