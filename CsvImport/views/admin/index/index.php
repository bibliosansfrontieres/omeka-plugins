...
jQuery(document).ready(function () {
    ...
    jQuery('#bsf_autodetect_type_collection').click(Omeka.CsvImport.bsf_updateImportOptions);
    Omeka.CsvImport.updateImportOptions(); // need this to reset invalid forms
    Omeka.CsvImport.bsf_updateImportOptions(); // need this to reset invalid forms
});
//]]>
</script>
<?php
