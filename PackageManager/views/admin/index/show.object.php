<?php
$json_keys = array("title","summary","lang","credits","tags","path","preview");
$export = array();
foreach($contents as $item_id){
	...
	$export[] = array_combine($json_keys, $fields);
	release_object($item);
}
echo json_encode($export, JSON_PRETTY_PRINT);
fire_plugin_hook('admin_package_export_json', array('data' => $export, 'view' => $this));